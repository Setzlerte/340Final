README
	...
	4. How Long Does A Reference Satisfied From Cache Take To Complete?
		Similar to how we find the time for main memory to compplete we slock the time before we iterate 			through an array and clock the time at the end. The difference here is that we stick to random 
